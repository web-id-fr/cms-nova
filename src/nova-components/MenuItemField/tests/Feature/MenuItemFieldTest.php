...
{
    public const UPDATE_ROUTE = '/nova-api/menus/{{id}}?viaResource=&viaResourceId=&viaRelationship=&editing=true&editMode=update';
    ...
    public function test_we_can_save_a_menu_with_parent_and_children_items()
    {
        ...
        $first_child_item = [
            'id' => 3,
            'type' => 'Webid\\CmsNova\\App\\Models\\Menu\\MenuCustomItem',
        ];
    ...
    public function test_we_can_save_a_menu_with_many_items_with_deep_children()
    {
        ...
        $data = [
            ...
            'menu_item' => json_encode([
                [
                    'id' => 1,
                    'menuable_type' => 'Webid\\CmsNova\\App\\Models\\Menu\\MenuCustomItem',
                    'children' => [
                        [
                            'id' => 2,
                            'title' => [
