                    ...
                    >
                        <template #option="{ option }">
                            <div class="flex bg-gray-200">
                                <div>
                                    <img width="100px" class="option__image" :src="option.imageAsset">
                                </div>
                                <div class="self-center text-gray-700 text-center px-4 py-2 m-2">
                                    <div class="option__desc">
                                        <span class="option__title">{{ selectFirstTitle(option.title) }}</span>
                                    </div>
                                </div>
                            </div>
                        </template>
                            ...
                            <div class="flex">
                                ...
                                <div class="flex min-h-full w-full border-60 border rounded-r-lg">
                                    <div class="self-center">
                                        <img class="m-auto block image-draggable" width="180px" :src="element.imageAsset">
                                    </div>
                                    <div class="flex-auto self-center p-4 m-2">
