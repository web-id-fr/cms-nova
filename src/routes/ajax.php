...
use Webid\CmsNova\App\Http\Controllers\Ajax\Menu\MenuConfigurationController;
use Webid\CmsNova\App\Http\Controllers\Ajax\Menu\MenuController;
use Webid\CmsNova\App\Http\Controllers\Ajax\Menu\MenuCustomItemController;
use Webid\CmsNova\App\Http\Controllers\Components\ComponentController;
...
Route::group([
    ...
    Route::post('menu-zone', [MenuConfigurationController::class, 'updateZone'])->name('menu_configuration.update');
});
