                            ...
                            <div class="relative flex bg-white mb-2 pb-1">
                                ...
                                <div class="flex min-h-full w-full border-60 border rounded-r-lg">
                                    <div class="flex-auto self-center text-center py-2 m-2">
                                        <p class="break-words">{{ selectFirstTitle(element.name) }}</p>
                                    </div>
                                </div>
                            </div>
                        </template>
...
export default {
    ...
    methods: {
        ...
        */
        ...
        moveUp(service) {
            let findIndex = _.findIndex(this.selected, service);
        ...
        deselectComponents(service) {
            const findIndex = _.findIndex(this.selected, service);
