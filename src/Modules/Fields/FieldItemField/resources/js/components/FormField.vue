                            ...
                            >
                                ...
                                <div class="flex min-h-full w-full border-60 border rounded-r-lg">
                                    <div class="flex-auto self-center text-center py-2 m-2">
                                        <p class="break-words">{{ selectFirstTitle(element.title, element.formable_type) }}</p>
                                    </div>
                                </div>
                            </div>
                        </template>
...
export default {
    ...
    methods: {
        ...
        */
        ...
        moveUp(field) {
            let findIndex = _.findIndex(this.selected, field);
        ...
        deselectComponents(field) {
            const findIndex = _.findIndex(this.selected, field);
        ...
        selectFirstTitle(title, formable_type) {
            ...
            if(formable_type === 'Webid\\CmsNova\\Modules\\Form\\Models\\TitleField'){
                type = 'Title  | '
            } else {
                type = 'Field | '
            }
