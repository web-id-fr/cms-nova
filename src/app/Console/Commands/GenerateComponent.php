...
namespace Webid\CmsNova\App\Console\Commands;
...
class GenerateComponent extends Command
{
    ...
    {
        $stub = $this->files->get(base_path("vendor/webid/cms-nova/src/app/Console/Commands/stubs/{$stubFileName}"));
        ...
        return str_replace('{{componentSpacedPluralName}}', $this->componentSpacedPluralName, $stub);
    }
